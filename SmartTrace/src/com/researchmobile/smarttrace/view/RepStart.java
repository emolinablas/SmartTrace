...
public class RepStart extends Activity implements OnClickListener{
	...
	public void onCreate(Bundle savedInstanceState){
		...
		setContentView(R.layout.rep_start);
	...
	private void ComponentPrepare() {
		...
		setUserCodeEditText((EditText)findViewById(R.id.rep_start_username_edittext));
		getUserCodeEditText().setOnClickListener(this);
		setBarrelCodeEditText((EditText)findViewById(R.id.rep_start_barrel_edittext));
		getBarrelCodeEditText().setOnClickListener(this);
		setStartButton((Button)findViewById(R.id.rep_start_enter_button));
