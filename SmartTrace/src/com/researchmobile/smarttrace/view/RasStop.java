...
public class RasStop extends Activity implements OnClickListener{
	...
	public void onCreate(Bundle saveInstanceState){
		...
		setContentView(R.layout.ras_stop);
	...
	private void ComponentPrepare() {
		setUserCodeEditText((EditText)findViewById(R.id.ras_stop_user_edittext));
		setBarrilCodeEditText((EditText)findViewById(R.id.ras_start_barrel_edittext));
		setInservibleTapaderaEditText((EditText)findViewById(R.id.ras_stop_inservible_tapadera_edittext));
		setInservibleBarrilEditText((EditText)findViewById(R.id.ras_stop_inservible_barril_edittext));
		
		setOrigenSpinner((Spinner)findViewById(R.id.ras_stop_origen_spinner));
		
		setAllFinishRadioButton((RadioButton)findViewById(R.id.ras_stop_allend_radiobutton));
		setParcialFinishRadioButton((RadioButton)findViewById(R.id.ras_stop_parcialend_radiobutton));
		
		setFinishButton((Button)findViewById(R.id.ras_stop_finish_button));
