...
public class QuemarStart extends Activity implements OnClickListener{
	...
	public void onCreate(Bundle savedInstanceState){
		...
		setContentView(R.layout.quemar_start);
	...
	private void ComponentPrepare() {
		...
		setUserCodeEditText((EditText)findViewById(R.id.quemar_start_username_edittext));
		getUserCodeEditText().setOnClickListener(this);
		setBarrelCodeEditText((EditText)findViewById(R.id.quemar_start_barrel_edittext));
		getBarrelCodeEditText().setOnClickListener(this);
		setStartButton((Button)findViewById(R.id.quemar_start_enter_button));
