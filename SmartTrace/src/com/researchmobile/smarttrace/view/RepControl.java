...
public class RepControl extends TabActivity implements OnTabChangeListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		getmTabHost().addTab(getmTabHost().newTabSpec("sample2").setIndicator("INICIAR", drawClock).setContent(new Intent(this, RepStart.class)));
		getmTabHost().addTab(getmTabHost().newTabSpec("sample3").setIndicator("FINALIZAR", drawStop).setContent(new Intent(this, RepStop.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP)));
		getmTabHost().addTab(getmTabHost().newTabSpec("sample4").setIndicator("RESUMEN", drawNote).setContent(new Intent(this, RepSummary.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP)));
