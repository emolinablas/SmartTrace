...
public class EmpStop extends Activity implements OnClickListener{
	...
	public void onCreate(Bundle saveInstanceState){
		...
		setContentView(R.layout.emp_stop);
	...
	private void ComponentPrepare() {
		setUserCodeEditText((EditText)findViewById(R.id.emp_stop_user_edittext));
		setBarrilCodeEditText((EditText)findViewById(R.id.emp_start_barrel_edittext));
		...
		setFinishButton((Button)findViewById(R.id.emp_stop_finish_button));
