...
public class LlenSummary extends Activity{
	...
	public void onCreate(Bundle savedInstanceState){
		...
		setContentView(R.layout.arm_summary);
	...
	private void ObtenerDatos() {
		...
		if (cant > 0){
			ListView listView = (ListView)findViewById(R.id.arm_summary_listview);
			
			setArrayList(convertArray(list.getBarrelList(), this));
			
			setSimpleAdapter(new SimpleAdapter(this, getArrayList(), R.layout.row_arm_summary,
	                new String[] {"code", "state", "date1", "date2"}, 
	                new int[] {R.id.row_arm_summary_code, R.id.row_arm_summary_state, R.id.row_arm_summary_date1, R.id.row_arm_summary_date2}));
	...
	private void ComponentPrepare() {
		setTotalTextView((TextView)findViewById(R.id.arm_summary_total_textview));
